...
function ShowInfo(result, kaoZone, value) {
    ...
    for(var j=0; j<matchResult.length; j++){
        innerContentStr +=
            ...
            '</div>'+
            '<div class="areaInfo">'+
            '<ul><li><img src="/JS_Kaohsiung_Travel/Images/icons_clock.png" alt="圖片不存在" class="iconsImg"><span class="sightseeingMsg">'+matchResult[j].Opentime+'</span></li>'+
            '<li><img src="/JS_Kaohsiung_Travel/Images/icons_pin.png" alt="圖片不存在" class="iconsImg"><span class="sightseeingAddr">'+matchResult[j].Add+'</span></li>'+
            '<li><img src="/JS_Kaohsiung_Travel/Images/icons_phone.png" alt="圖片不存在" class="iconsImg"><span class="sightseeingTel">'+matchResult[j].Tel+'</span></li></ul>'+
            '<div class="areaFree">'+
            '<ul><li><img src="/JS_Kaohsiung_Travel/Images/icons_tag.png" alt="圖片不存在" class="iconsImg"><span class="sightseeingTag">'+matchResult[j].Ticketinfo+'</span></li></ul>'+
            '</div></div></div>';
